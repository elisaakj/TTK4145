...
// changed to get simulator working
func hardwareInit(elevatorID int) {
	var err error
	simulatorPort := fmt.Sprintf("localhost:%d", 20100+elevatorID)
	sock, err = net.Dial("tcp", simulatorPort)
	if err != nil {
